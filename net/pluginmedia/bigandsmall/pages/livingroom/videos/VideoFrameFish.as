package net.pluginmedia.bigandsmall.pages.livingroom.videos
{
   ...
   public class VideoFrameFish extends FramedVideoPage3D
   {
      
      public function VideoFrameFish(param1:BasicView, param2:String, param3:Page3D = null)
      {
         var _loc5_:OrbitCamera3D = null;
         var _loc4_:Number3D = new Number3D(-172,285,244);
      ...
      override protected function receiveFrame(param1:IAssetLoader) : void
      {
         ...
         --videoPlane.z;
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_C_FRAME,hiResFrame);
         var _loc2_:DisplayObject3D = hiResFrame.getChildByName("Image2",true);
      ...
      override public function onShareableRegistration() : void
      {
         ...
         dispatchShareRequest(new ShareRequest(this,"VideoFrame.Fish",handleSetLowResFrame));
         dispatchShareRequest(new ShareRequest(this,"VideoFileA",handleVideoLocation));
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_C_VIDEO,videoPlane);
      }
      
      override public function onRegistration() : void
      {
         super.onRegistration();
         dispatchAssetRequest("VideoFrameFish.frameDae",DAELocations.livingRoomVideoFrameFish,receiveFrame);
      }
      ...
      override public function getLiveVisibleDisplayObjects() : Array
      {
         ...
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_C_FRAME);
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_C_VIDEO);
         return _loc1_;
      }
