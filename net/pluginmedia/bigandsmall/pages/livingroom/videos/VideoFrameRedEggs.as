package net.pluginmedia.bigandsmall.pages.livingroom.videos
{
   ...
   public class VideoFrameRedEggs extends FramedVideoPage3D
   {
      
      public function VideoFrameRedEggs(param1:BasicView, param2:String, param3:Page3D = null)
      {
         var _loc5_:OrbitCamera3D = null;
         var _loc4_:Number3D = new Number3D(-304.5,240,196);
      ...
      override protected function receiveFrame(param1:IAssetLoader) : void
      {
         ...
         hiResFrame.scale = 27;
         hiResFrame.rotationY = 90;
         videoPlane.x += 0.9;
         videoPlane.rotationY = 270;
         videoPlane.x += 1.5;
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_E_FRAME,hiResFrame);
         var _loc2_:DisplayObject3D = hiResFrame.getChildByName("Image3",true);
      ...
      override public function onShareableRegistration() : void
      {
         ...
         dispatchShareRequest(new ShareRequest(this,"VideoFrame.RedEggs",handleSetLowResFrame));
         dispatchShareRequest(new ShareRequest(this,"VideoFileF",handleVideoLocation));
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_E_VIDEO,videoPlane);
      }
      
      override public function onRegistration() : void
      {
         super.onRegistration();
         dispatchAssetRequest("VideoFrameRedEggs.frameDae",DAELocations.livingRoomVideoFrameRedEggs,receiveFrame);
      }
      ...
      override public function getLiveVisibleDisplayObjects() : Array
      {
         ...
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_E_FRAME);
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_E_VIDEO);
         return _loc1_;
      }
