package net.pluginmedia.bigandsmall.pages.livingroom.videos
{
   ...
   public class VideoFrameBlueFlower extends FramedVideoPage3D
   {
      
      public function VideoFrameBlueFlower(param1:BasicView, param2:String, param3:Page3D = null)
      {
         var _loc5_:OrbitCamera3D = null;
         var _loc4_:Number3D = new Number3D(325,245,244);
      ...
      override protected function receiveFrame(param1:IAssetLoader) : void
      {
         ...
         videoPlane.z -= 1.5;
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_F_FRAME,hiResFrame);
         var _loc2_:DisplayObject3D = hiResFrame.getChildByName("Image4",true);
      ...
      override public function onRegistration() : void
      {
         ...
         dispatchAssetRequest("VideoFramePurpleFlower.frameDae",DAELocations.livingRoomVideoFrameBlueFlower,receiveFrame);
      }
      ...
      override public function getLiveVisibleDisplayObjects() : Array
      {
         ...
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_F_FRAME);
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_F_VIDEO);
         return _loc1_;
      }
      ...
      override public function onShareableRegistration() : void
      {
         ...
         dispatchShareRequest(new ShareRequest(this,"VideoFrame.PurpleFlower",handleSetLowResFrame));
         dispatchShareRequest(new ShareRequest(this,"VideoFileC",handleVideoLocation));
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_F_VIDEO,videoPlane);
      }
   }
}
