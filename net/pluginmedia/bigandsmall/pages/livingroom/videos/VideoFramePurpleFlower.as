package net.pluginmedia.bigandsmall.pages.livingroom.videos
{
   ...
   public class VideoFramePurpleFlower extends FramedVideoPage3D
   {
      
      public function VideoFramePurpleFlower(param1:BasicView, param2:String, param3:Page3D = null)
      {
         var _loc5_:OrbitCamera3D = null;
         var _loc4_:Number3D = new Number3D(-199,226,244);
      ...
      override protected function receiveFrame(param1:IAssetLoader) : void
      {
         ...
         videoPlane.z -= 1.5;
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_D_FRAME,hiResFrame);
         var _loc2_:DisplayObject3D = hiResFrame.getChildByName("Image5",true);
      ...
      override public function onShareableRegistration() : void
      {
         ...
         dispatchShareRequest(new ShareRequest(this,"VideoFrame.BlueFlower",handleSetLowResFrame));
         dispatchShareRequest(new ShareRequest(this,"VideoFileE",handleVideoLocation));
         registerLiveDO3D(DO3DDefinitions.VIDEOFRAME_D_VIDEO,videoPlane);
      }
      
      override public function onRegistration() : void
      {
         super.onRegistration();
         dispatchAssetRequest("VideoFrameBlueFlower.frameDae",DAELocations.livingRoomVideoFramePurpleFlower,receiveFrame);
      }
      ...
      override public function getLiveVisibleDisplayObjects() : Array
      {
         ...
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_D_FRAME);
         _loc1_.push(DO3DDefinitions.VIDEOFRAME_D_VIDEO);
         return _loc1_;
      }
