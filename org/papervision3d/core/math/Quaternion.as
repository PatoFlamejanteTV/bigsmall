package org.papervision3d.core.math
{
   public class Quaternion
   {
      ...
      public static function createFromEuler(param1:Number, param2:Number, param3:Number, param4:Boolean = false) : Quaternion
      {
         ...
         var _loc13_:Quaternion = new Quaternion();
      ...
      public static function createFromMatrix(param1:Matrix3D) : Quaternion
      {
         ...
         var _loc8_:Number = param1.n11 + param1.n22 + param1.n33;
         if(_loc8_ > 0)
         {
      ...
      public static function slerp(param1:Quaternion, param2:Quaternion, param3:Number) : Quaternion
      {
         ...
         var _loc4_:Number = param1.w * param2.w + param1.x * param2.x + param1.y * param2.y + param1.z * param2.z;
         if(_loc4_ < 0)
         {
            param1.x *= -1;
            param1.y *= -1;
      ...
      {
         var _loc1_:Number = x * x;
         var _loc2_:Number = x * y;
         var _loc3_:Number = x * z;
         var _loc4_:Number = x * w;
         var _loc5_:Number = y * y;
         var _loc6_:Number = y * z;
         var _loc7_:Number = y * w;
         var _loc8_:Number = z * z;
         var _loc9_:Number = z * w;
