      ...
      public static function invertMatrix(param1:Array, param2:Array) : Boolean
      {
         ...
         while(_loc3_ < 4)
         {
            ...
            if(_loc6_ != _loc3_)
            {
               ...
               while(_loc5_ < 4)
               {
                  _loc7_ = Number(_loc8_[_loc3_][_loc5_]);
                  _loc8_[_loc3_][_loc5_] = _loc8_[_loc6_][_loc5_];
                  _loc8_[_loc6_][_loc5_] = _loc7_;
                  _loc7_ = Number(param2[_loc3_ * 4 + _loc5_]);
            ...
            _loc7_ = Number(_loc8_[_loc3_][_loc3_]);
            _loc5_ = 0;
            while(_loc5_ < 4)
            {
               _loc8_[_loc3_][_loc5_] /= _loc7_;
               param2[_loc3_ * 4 + _loc5_] /= _loc7_;
               _loc5_++;
            }
            _loc4_ = 0;
            while(_loc4_ < 4)
            {
               if(_loc4_ != _loc3_)
               {
                  _loc7_ = Number(_loc8_[_loc4_][_loc3_]);
                  _loc5_ = 0;
                  while(_loc5_ < 4)
                  {
                     _loc8_[_loc4_][_loc5_] -= _loc8_[_loc3_][_loc5_] * _loc7_;
                     param2[_loc4_ * 4 + _loc5_] -= param2[_loc3_ * 4 + _loc5_] * _loc7_;
                     _loc5_++;
                  }
               }
               _loc4_++;
