package org.papervision3d.core.math
{
   ...
   public class Matrix3D
   {
      ...
      {
         param2 ||= new Number3D();
         var _loc4_:Number = Boolean(param3) && param3.x == 1 ? 1 : Math.sqrt(param1.n11 * param1.n11 + param1.n21 * param1.n21 + param1.n31 * param1.n31);
         var _loc5_:Number = Boolean(param3) && param3.y == 1 ? 1 : Math.sqrt(param1.n12 * param1.n12 + param1.n22 * param1.n22 + param1.n32 * param1.n32);
         var _loc6_:Number = Boolean(param3) && param3.z == 1 ? 1 : Math.sqrt(param1.n13 * param1.n13 + param1.n23 * param1.n23 + param1.n33 * param1.n33);
      ...
      public static function multiplyQuaternion(param1:Object, param2:Object) : Object
      {
         ...
         var _loc7_:Number = Number(param2.x);
         var _loc8_:Number = Number(param2.y);
         var _loc9_:Number = Number(param2.z);
         var _loc10_:Number = Number(param2.w);
