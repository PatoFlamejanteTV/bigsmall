package org.papervision3d.core.geom
{
   ...
   public class TriangleMesh3D extends Vertices3D
   {
      ...
      public function projectTexture(param1:String = "x", param2:String = "y") : void
      {
         ...
         var _loc4_:Object = this.boundingBox();
         var _loc5_:Number = Number(_loc4_.min[param1]);
         var _loc6_:Number = Number(_loc4_.size[param1]);
         var _loc7_:Number = Number(_loc4_.min[param2]);
         var _loc8_:Number = Number(_loc4_.size[param2]);
      ...
      override public function project(param1:DisplayObject3D, param2:RenderSessionData) : Number
      {
         ...
         _dtStore = [];
         _dtActive = new Array();
         var _loc3_:int = int(this.geometry.vertices.length);
         var _loc4_:Array = [];
         if(param2.clipping && this.useClipping && !this.culled && (param2.camera.useCulling ? cullTest == 0 : true))
         {
         ...
         if(!this.culled)
         {
            ...
            for each(_loc14_ in _loc4_)
            {
               ...
               {
                  _loc16_ = _loc14_.renderCommand;
                  _loc7_ += _loc16_.screenZ = setScreenZ(meshSort,_loc10_,_loc11_,_loc12_);
                  _loc8_++;
                  ...
                  if(param2.quadrantTree)
                  {
                     ...
                     {
                        _loc16_.create = createRenderTriangle;
                     }
                     _loc16_.update();
      ...
      public function createRenderTriangle(param1:Triangle3D, param2:MaterialObject3D, param3:Vertex3DInstance, param4:Vertex3DInstance, param5:Vertex3DInstance, param6:NumberUV, param7:NumberUV, param8:NumberUV) : RenderTriangle
      {
         ...
         {
            _dtActive.push(_tri = new RenderTriangle(param1));
         }
         _tri.instance = this;
